"""
Django settings for empty_silence_40207 project.
...
ROOT_URLCONF = 'empty_silence_40207.urls'
...
WSGI_APPLICATION = 'empty_silence_40207.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_silence_40207 API",
    "DESCRIPTION": "API documentation for empty_silence_40207 App",
    "VERSION": "v1",
}
